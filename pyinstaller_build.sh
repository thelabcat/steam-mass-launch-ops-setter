...
# Setting the script name to be built
progname="steam_mass_launch_ops_setter"
...
echo "Building exe"
# --icon=$progname.ico --add-data $progname.png:. --add-data large_en.msgpack.gz:wordfreq/data/
# $progname.py might be $progname.pyw
